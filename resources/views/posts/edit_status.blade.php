        ...
        <div class="col-md-7	 col-md-offset-3">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('update_status_post', ['post' => $post->id]) }}">
                        {{ csrf_field() }}
                   ...
                   <font color="#00008B" size=4> Район прибытия -</font> <font color="#ff0000" size=4> {{ $post->p_p }} </font><br>
                    <font color="#00008B" size=4>Стоимость заказа -</font> <font color="#ff0000" size=4> {{ $post->val }}р. </font><br>
						<font color="#000000" size=5> Вы действительно хотите принять данный заказ?</font>
						</div>	
