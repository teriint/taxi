        ...
        <div class="col-md-7	 col-md-offset-3">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('update_ok_post_en', ['post' => $post->id]) }}">
                        {{ csrf_field() }}
                   ...
                   <font color="#00008B" size=4> Arrival Area -</font> <font color="#ff0000" size=4> {{ $post->p_p }} </font><br>
                    <font color="#00008B" size=4>Order cost -</font> <font color="#ff0000" size=4> {{ $post->val }}р. </font><br>
						<font color="#000000" size=5>Complete the order?</font>
						</div>	
             ...
             <div class="form-group{{ $errors->has('val') ? ' has-error' : '' }}">
               ...
               <div class="form-group">
                           <!-- <label for="stat" class="col-md-4 control-label">Новый статус</label> -->
                            ...
                            <div class="col-md-6">
                                <input style="visibility: hidden" id="stat" type="radio" checked="Выполнен" class="form-control" name="stat" readonly="" value="Выполнен" required autofocus>
